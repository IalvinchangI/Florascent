  ...
  <div class="client-container">
    ...
    <template v-else>
      ...
      <template v-else>
        ...
        <Intro v-else-if="currentStage === Stage.Intro" :role="role" :lang="userLang" :songData="songData" @[LANG_SELECT]="setLang" />
        <!-- <Vote v-else-if="currentStage === 'Vote'" :role="role" :lang="userLang" :song="songData" /> -->
        <!-- <Result v-else-if="currentStage === 'Result'" :role="role" :lang="userLang" :song="songData" /> -->
...
import { LANG, ROLE, LANG_SELECT, Stage } from '@/constants.js';
